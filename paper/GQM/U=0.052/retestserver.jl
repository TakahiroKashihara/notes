...
@everywhere function swise(M,U,p::Parm)
    w,imsA,resA = test("/home/t-kashihara/numerical/100t_DMFTphs_08_29/M=$M/U=$U/Sigma_A12.dat")

    w,imsB,resB = test("/home/t-kashihara/numerical/100t_DMFTphs_08_29/M=$M/U=$U/Sigma_B12.dat")

    omegah = collect(0.:p.R/p.Nw:p.R)#積分に使うinput周波数
    popfirst!(omegah)
    omega = collect(-p.R:p.R/p.Nw:p.R)#積分に使う周波数
