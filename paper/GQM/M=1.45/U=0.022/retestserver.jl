...
@everywhere function swise(M,U,p::Parm)
    w,imsA,resA = test("/home/t-kashihara/numerical/100t_DMFT_07_26/M=$M/U=$U/Sigma_A12.dat")

    w,imsB,resB = test("/home/t-kashihara/numerical/100t_DMFT_07_26/M=$M/U=$U/Sigma_B12.dat")
